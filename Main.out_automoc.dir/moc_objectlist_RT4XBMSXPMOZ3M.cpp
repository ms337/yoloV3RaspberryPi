...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ObjectList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ObjectList_t qt_meta_stringdata_ObjectList = {
    {
QT_MOC_LITERAL(0, 0, 10) // "ObjectList"
...
const QMetaObject ObjectList::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ObjectList.data,
      qt_meta_data_ObjectList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ObjectList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ObjectList.stringdata0))
